...
public class HomeFragment extends Fragment {
    ...
    private void getImagesCiudad(){
        Ciudad.add("Madrid");
        ImagenCiudad.add("https://img.freepik.com/vector-gratis/camping-al-aire-libre-logo-icono-vector-concepto-retro-ilustracion-diseno_557439-457.jpg?w=2000");
